...
from . import BBoxHeadIncrease


@MODELS.register_module()
class ConvFCBBoxHeadIncrease(BBoxHeadIncrease):
...
@MODELS.register_module()
class Shared2FCBBoxHeadIncrease(ConvFCBBoxHeadIncrease):
...
@MODELS.register_module()
class Shared4Conv1FCBBoxHeadIncrease(ConvFCBBoxHeadIncrease):
