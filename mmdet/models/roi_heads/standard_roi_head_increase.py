...
class StandardRoIHeadIncrease(BaseRoIHead):
    ...
    def loss_weight(self,
                    ...
                    pseudo_label_cls_weights_list:List,
                    pseudo_label_reg_weights_list:List,
                    gt_pseudo_num:List,
                    gt_new_num:List,
                    ori_num_classes: int,
                    num_classes: int
        ...
        # bbox head loss
        if self.with_bbox:
            bbox_results = self.bbox_loss_weight(
                x,
                sampling_results,
    ...
    def bbox_loss_weight(self, x: Tuple[Tensor],
        ...
        bbox_loss_and_target = self.bbox_head.loss_and_target_weight(
            cls_score=bbox_results['cls_score'],
            bbox_pred=bbox_results['bbox_pred'],
            rois=rois,
            sampling_results=sampling_results,
