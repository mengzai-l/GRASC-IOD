...
class DSAChecker:
    def __init__(self, clip_path, all_classes, device="cuda:0"):
        ...
        # 10+5 specific defense map
        self.defense_map = {
            "aeroplane": ["bird"], "bird": ["aeroplane"], "boat": ["aeroplane"],
            "bicycle": ["motorbike", "person"], "bottle": ["diningtable", "person"],
            "bus": ["train", "car"], "car": ["train", "bus"],
            "cat": ["dog", "horse", "sheep"], "cow": ["sheep", "dog", "horse"],
