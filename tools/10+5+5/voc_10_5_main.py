...
from voc_10_5_LFF import LFFGenerator
from voc_10_5_DSA import DSAChecker
from voc_10_5_ASC import ASCCalibrator

# ==============================================================================
# 1. Configuration
# ==============================================================================
VOC_ROOT = Path("data/VOC2007")
AUG_ROOT = Path("data/VOC2007_10+5")
...
PREV_CLASSES = ["aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow"]
NEW5_CLASSES = ["diningtable", "dog", "horse", "motorbike", "person"]
ALL_CLASSES = PREV_CLASSES + NEW5_CLASSES

RIGID_CLASSES = ["aeroplane", "bicycle", "boat", "bottle", "bus", "car", "chair"]
NON_RIGID_CLASSES = ["bird", "cat", "cow"]
...
SRC_LIST_FOR_GEN = VOC_ROOT / "10+5+5/task0_trainval.txt"
SRC_LIST_FOR_NEW = VOC_ROOT / "10+5+5/task1_trainval.txt"
LIST_FINAL_TASK2 = VOC_ROOT / "ImageSets/Main/final_merged_10_5.txt"

if __name__ == "__main__":
    print("=" * 60)
    print("🚀 GRASC-IOD: VOC 10+5 Main Pipeline Started")
    print("=" * 60)
    ...
    pbar = tqdm(total=len(PREV_CLASSES) * TARGET_PER_CLASS, desc="Generation & Filtering")
    ...
    # --- Phase 2: Copy Real Task 1 Whitelist Data ---
    ...
    print(f"\n🎉 GRASC-IOD 10+5 data preparation finished: {FINAL_LIST_PATH}")